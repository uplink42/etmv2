...
class Register_model extends CI_Model
{
     ...
     * @return array
     */
    public function validate(string $username, string $password, string $repeatpassword, string $email, string $reports, string $character): array
    {
        $result = array("username" => $this->validateUsername($username),
            ...
            "character"                => $this->validateCharacter($character),
        );
    ...
    private function validateCharacter(string $characterID)
    {
        if (!$this->ValidateRequest->checkCharacterFree($characterID)) {
