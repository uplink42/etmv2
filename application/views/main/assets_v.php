                ...
                <div class="view-header">
                    ...
                    <?php 
                        for($i=0; $i<count($character_list); $i++) {
                            ?>
                        <li><a href="<?=base_url('Assets/index/'.$character_list['chars'][$i])?>"><?=$character_list['char_names'][$i]?></a></li>    
                    <?php
                       }
                    ?>
                        <li role="separator" class="divider"></li>
                        <?php $url = "Assets/index/".$character_id."/1";?>
                    ...
                    <div class="header-title">
                        <h1><?php echo $aggregate == 1 ? implode(' + ', $char_names) : $character_name?>'s Assets</h1>
                    </div>
                </div>
                <hr>
            </div>
